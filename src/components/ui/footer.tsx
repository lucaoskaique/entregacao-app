import SOS from '@/assets/images/sos-footer.png'
    ...
    <section className="bg-neutral-900 pb-[56.41px] pt-7">
      <Container>
        <div className='max-w-[1000px] m-auto'>
          <div className="flex justify-center gap-2 items-center my-[41px]">
            <LogoIcon color="white" width={32.94} height={28.6} />
            <LogoName color="white" width={178.78} height={37.3} />
          </div>
          ...
          <section className="flex flex-col tablet:flex-row tablet:gap-12 justify-between gap-2 my-[24px] px-10 tablet:h-[150px]">
            <div className="tablet:w-[50%] text-black bg-white flex flex-col rounded-lg items-center py-[11px] gap-[10px] tablet:h-full tablet:flex-row tablet:justify-center h-[153px]">
            ...
            <div className="tablet:w-[50%] bg-[#212121]/40 border border-[#262626] flex items-center justify-center gap-x-4 rounded-xl tablet:h-full h-[91px]">
              <InstagramIcon width={34} height={34} />
              <span className="text-white font-inter-medium text-2xl">@sos.cozinhas</span>
            </div>
          </section>
          <div className="text-neutral-300 border-t-2 border-neutral-800 mx-5 tablet:mx-1">
